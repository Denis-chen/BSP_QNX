...
i2c_status_t
dm6446_send(void *hdl, void *buf, unsigned int len, unsigned int stop)
{
    ...
    out32(base + DM6446_I2C_ICMDR, DM6446_I2C_ICMDR_IRS | DM6446_I2C_ICMDR_MST | DM6446_I2C_ICMDR_TRX);
	...
	dev->cur_len = 0;
	dev->buf     = buf;
	dev->txrx    = JACINTO_I2C_TX;
	dev->stop    = stop;

	/* Enable interrupts */
	out32(base + DM6446_I2C_ICIMR,
			DM6446_I2C_ICIMR_AL | DM6446_I2C_ICIMR_NACK | 
			DM6446_I2C_ICIMR_AAS | DM6446_I2C_ICIMR_ICXRDY |
