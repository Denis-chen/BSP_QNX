...
/* __SRCVERSION("ntocam.h $Rev: 392398 $"); */
...
#define DEXT_EFLG_SYNC_SUP		0x10		// synchronize cache support
...
int		scsi_interpret_sense( DEVOBJ *dobj, CCB_SCSIIO *ccb, int *status, int rcount );
int		scsi_inquiry( DEVOBJ *dobj, void *inq, int ilen );
