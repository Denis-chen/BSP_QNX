...
extern void print_arm_boxinfo(void);
extern void print_arm_cpu(void);

#define CPU_PRT_SYSPAGE_RTNS					\
	CPU_PRT_SYSPAGE_RTN(arm, 1, boxinfo),		\
	CPU_PRT_SYSPAGE_RTN(arm, 1, cpu),
...
/* __SRCVERSION("cpu_startup.h $Rev: 392398 $"); */
