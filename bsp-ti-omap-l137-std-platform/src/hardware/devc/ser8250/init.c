...
enable_device( DEV_8250 *dev)
{
	...
	write_8250(dev->port[REG_PWREMU], (PWREMU_FREE | PWREMU_URRST | PWREMU_UTRST));	/* Enable Tx/Rx in Free running mode */
	write_8250(dev->port[REG_MDR], 0x0);	/* 16x over-sampling */
#endif
