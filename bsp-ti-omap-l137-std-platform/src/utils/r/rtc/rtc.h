...
extern int init_omapl1xx(struct chip_loc *chip, char *argv[]);
extern int get_omapl1xx(struct tm *tm, int cent_reg);
extern int set_omapl1xx(struct tm *tm, int cent_reg);
